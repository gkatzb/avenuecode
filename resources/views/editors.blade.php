...
@include('includes.modal.modal-books-details')
@section('content')
	...
	<div class="cabecalho_tabela">
		<span class="header-colaboradores">
			...
			<a href="" data-editor-id="" data-name="" data-company-id="" data-toggle="modal" data-target="#modal-editor-details"><img class="ico_mais" src="/img/ico-add.png" alt=""></a>
		</span>
